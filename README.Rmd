...
[![Codecov test coverage](https://codecov.io/gh/BradyAJohnston/figpatch/branch/master/graph/badge.svg)](https://codecov.io/gh/BradyAJohnston/figpatch?branch=master)
<!-- badges: end -->
...
To add internal tags to the figs, use the `figtag()` function. Assembling with
...
A number of default positions can be supplied to `figtag(pos = ...)` or a custom
