...
You can install the released version of figpatch from [CRAN](https://cran.r-project.org/package=figpatch) with:

``` r
install.packages("figpatch")
```

Install the development version from [GitHub](https://github.com/BradyAJohnston/figpatch) with:
